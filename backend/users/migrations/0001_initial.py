    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pharmacy_name', models.CharField(blank=True, max_length=255, verbose_name='Nom de la pharmacie')),
                ('role', models.CharField(choices=[('admin', 'Administrateur'), ('user', 'Utilisateur'), ('pharmacist', 'Pharmacien')], default='user', max_length=20, verbose_name='Rôle')),
